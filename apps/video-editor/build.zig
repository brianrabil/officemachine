...
const default_native_sdk_path = "/Users/rabilb/.vite-plus/js_runtime/node/24.18.0/lib/node_modules/@native-sdk/cli";
const app_exe_name = "video-editor";
...
pub fn build(b: *std.Build) void {
    ...
    const package_clean = b.addSystemCommand(&.{ "rm", "-rf", package_output });
